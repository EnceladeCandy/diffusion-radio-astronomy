...
samples = torch.load("../../samples_targets/HTLup_continuum0.0015arcsec2/euler/0.pt", map_location=device).reshape(-1, 256, 256).cpu().numpy() # snr = 1e-2, corr= 20
header, dirty_image = fits_to_tensor("../../data_targets2/HTLup_continuum0.0015arcsec2.fits")
